...
public final class UpdateStatus {
    ...
    public static void main(String[] args) {
        ...
        try {
        	...
        	props.setProperty("oauth.consumerSecret","Wk3XdtBDyGRLq5dz20NMasrzQ4BfeRvbPSQ1iKaI");
        	props.setProperty("media.providerAPIKey","CWZTZc23tw5VToWaHZSjkQf2b");
        	props.setProperty("oauth.consumerKey","USLG8ce1GgCOTzmxODYyg");
            ...
            Twitter twitter = new TwitterFactory(propertyConfiguration).getInstance(
            		new AccessToken("2674244424-sZ0gmqAVK4Dmk6h4aBdBfJX0R2H9SLxr2h54kB2", 
            				"OZLpXerJNJkaxmmk07R6OhKGZMs3jtwdENfHdcCJwizPd"));
            try {
                // get request token.
