...
<div align="left" class="mainText">
  ...
  <div style="margin-bottom: 8px;"><?php include $_SERVER['DOCUMENT_ROOT']."/art/template/facebook.php"; ?></div>
  <div><?php include $_SERVER['DOCUMENT_ROOT']."/art/template/twitter.php"; ?></div>
